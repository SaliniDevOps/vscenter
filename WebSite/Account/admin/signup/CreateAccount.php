        ...
        <div class="left-container">
            ...
            <div class="main-title-content">
                <div class="logo-container">
                    ...
                    <br>
                    <a href="#" class="logo">Create Account</a>
                </div>
            </div>
        </div>
        ...
        <div class="right-container">
            <div class="service-booking-content">
                <form action="">
					...
					<div class="inputbox">
                        <input type="tel" placeholder="Phone Number" maxlength=10 id="phone" oninput="validateInput(this)">
					...
					<div class="inputbox">
                        <input type="text" placeholder="Vehicle Number" id="vehicleNumber">
					...
					<div class="inputbox">
						...
						<div class="textalert12" style="color:red; font-weight:bold;"  ></div>
                         <i class="ri-file-user-fill"></i>
                    </div>
					
					<div class="inputbox">
                        <input type="Password" placeholder="Confirm Password" id="ConfirmPassword">
						<div class="textalert13" style="color:red; font-weight:bold;"  ></div>
                         <i class="ri-file-user-fill"></i>
                    </div>
                    ...
                    <div class="inputbox" hidden>
                        <textarea placeholder="Note" rows="4" id="comments" style="width:550px;"></textarea>
