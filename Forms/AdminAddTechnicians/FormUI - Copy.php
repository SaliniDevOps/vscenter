										...
										<form id="form1" name="form1" method="post" autocomplete="off" action="">
											...
											<div class="d-flex justify-content-between align-items-center">
												<div class="col-md-12 main-content d-flex align-items-center">
													...
													<input type="text" id="NIC"  class="form-control" style="width: 400; margin-left:10px; "  >	
													...
													&nbsp;&nbsp;&nbsp;<input type="text" id="Name"  class="form-control" style="width: 400;"  >
													...
													&nbsp;&nbsp;&nbsp;<input type="text" id="Address"  class="form-control" style="width: 400;"  >
											...
											<div class="d-flex justify-content-between align-items-center">
												<div class="col-md-12 main-content d-flex align-items-center">
													...
													<input type="text" id="Mobile"  class="form-control" style="width: 225; margin-left:10px; "  >
													...
													&nbsp;&nbsp;&nbsp;<input type="text" id="Mail"  class="form-control" style="width: 225;"  >
													<div class="textalert5" style="color:red; font-weight:bold;"  ></div>
													
													&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary ml-2" style="margin-left:115px;" id="Add_Button">Add</button>			
												</div>
											</div>
