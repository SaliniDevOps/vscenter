...
<head>
  ...
  <title>Add Vehicle Type Interface </title>
										...
										<form id="form1" name="form1" method="post" autocomplete="off" action="">
											<div class="d-flex justify-content-between align-items-center">
												...
												<div class="col-md-11 main-content d-flex align-items-center" >
													...
													<label for="spareName" class="col-form-label col-md-3" >Enter Vehicle Models </label>
													...
													<div class="form-group mb-6" style="position: relative;">
														...
														<div class="textalert1" id="ValiAlertCSS">Please Enter the Vehicle Model</div>
													</div>
