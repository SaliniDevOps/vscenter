 ...
 <script type="text/javascript">
    $(function() {
		$("#Add_Button").click(function() {
			...
			var dataString = 'Insert_txtID='+ ID + '&ServiceType='+ ServiceType; 
							
			if(ServiceType==''){
				$(".textalert1").fadeIn(100).html(' <span class="closebtn" onclick="this.parentElement.style.display="none";"></span>Enter the Spare Part Model');
