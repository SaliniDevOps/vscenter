<?php 
	//AJAX 
	include('AddServiceTypeAjax.php');
...
<head>
  ...
  <title>Add Service Type Interface </title>
			...
			<div class="col-lg-8">
				<div class="row">
					<section class="section">
						<div class="row">
							<div class="col-md-12">
								<div class="card" style="background-color: #b3cccc;">
									<div class="card-body">
										<form id="form1" name="form1" method="post" autocomplete="off" action="">
											...
											<div class="d-flex justify-content-between align-items-center">
												...
												<div class="col-md-11 main-content d-flex align-items-center" >
													...
													<label for="spareName" class="col-form-label col-md-3" >Enter Service Type</label>
													<input type="text" hidden id="txtServiceTypeID">
													<div class="form-group mb-6" style="position: relative;">
														<input type="text" class="form-control" id="txtServiceType" name="txtServiceType" style="width: 350px;" required>
														<div class="textalert1" id="ValiAlertCSS">Please enter a service type.</div>
													</div>
												</div>
											</div>
											<div class="d-flex justify-content-between align-items-center">
												<div class="col-md-11 main-content d-flex align-items-center">
													<label for="txtPrice" class="col-form-label col-md-3" style="margin-left:60px;">Price</label>
													
													<input type="text" class="form-control" id="txtPrice" name="txtPrice" style="width: 348;">
													<div class="textalert1" id="ValiAlertCSS">Please Enter the Spare Part Name</div>
