							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
											...
											<div class="d-flex justify-content-between align-items-center">
												<div class="form-group mb-6" style="position: relative;">
													...
													<div>
														...
														<input type="text" class="form-control" id="txtServiceType" name="txtServiceType" required>
														<div class="textalert1" id="ValiAlertCSS">Please enter a service type.</div>
													</div>
												</div>
												<div>
													<button type="button" class="btn btn-primary ml-3" id="Add_Button">Add</button>
												</div>
											</div>
										</form>
										...
										<br> <div class="alertSave" id="Save_AlertCSS" style="display:none"></div>
										<br> <div class="alertWarning" id="Warning_AlertCSS" style="display:none"></div>
